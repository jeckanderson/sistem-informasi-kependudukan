<div class="row">
    <div class="col-md-12">
        ...
        <h3 style="text-align: center; padding-top: 6px;">LAPORAN DATA KEMATIAN</h3>
        ...
        <table cellpadding="10" cellspacing="0" border="1" style="font-size: 16px; padding-top: 20px; width: 100%;">
            ...
            @foreach ($cetaklap as $item)
                <tr>
                    ...
                    <td>{{ $item->jender }}</td>
                    <td>-</td>
                    <td>{{ date("d F Y", strtotime($item->tgl_meninggal)) }}</td>
        ...
        @else
            <h5 class="bg-danger text-white text-center">Data Kematian tidak ditemukan</h5>
        @endif
